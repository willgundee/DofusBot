...
namespace Gofus
{
    public class Statistique
    {
        ...
        private static Dictionary<element, string> dictElement = new Dictionary<element, string>()//dictionnaire servant à transformer les nom de la bd en nom lisible pour l'homme
        #region dict
        {
        ...
        #endregion
        public static Dictionary<int, double> dictLvl = new Dictionary<int, double>()
        #region les levels
        ...
        [JsonConstructor]
        public Statistique(element Nom, string NomSimple, double Valeur, double ValeurMin, double ValeurMax)
        {
            this.Nom = Nom;
