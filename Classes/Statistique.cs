...
namespace test
{
    public class Statistique
    {
            ...
            #region dict
        {
            ...
            {element.RES_Pourcent_air,"Pourcentage de résistance air"},
            {element.RES_Pourcent_eau,"Pourcentage de résistance eau"},
            {element.RES_Pourcent_feu,"Pourcentage de résistance feu"},
            {element.RES_Pourcent_neutre,"Pourcentage de résistance neutre"},
            {element.RES_Pourcent_terre,"Pourcentage de résistance terre"},
